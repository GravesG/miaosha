...
public class RedisService {
    ...
    public <T> T get(KeyPrefix prefix,String key,Class<T> clazz){
        ...
        try {
            ...
            //生成正真得key
            String realKry = prefix.getPrefix()+key;
            String str = jedis.get(realKry);
    ...
    public <T> Boolean set(KeyPrefix prefix,String key,T value){
        ...
        try {
            ...
            if(seconds <= 0){
                jedis.set(realKry,str);
            }else{
                jedis.setex(realKry,seconds,str);
            }
